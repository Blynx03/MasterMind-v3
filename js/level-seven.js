      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          newContent2.textContent =
            "Outrageous! Very few made it this far, so you should be proud. Next level requires more concentration. If you fail, you will be brought back to level one. Countdown is reduced to one(1) minute. Relax before you proceed. May all the people of Earth be with you! :)";
