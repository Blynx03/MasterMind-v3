    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          newContent1.textContent = "Level 7 Unlocked!";
          newContent2.className = "level level-description";
          newContent2.textContent =
            "It feels like Dopamine, Serotonin, Endorphins and Oxytocin were released in your brain. Keep it going as the next one is more rewarding. Timer is reduced to two(2) minutes. Stay focused!";
...
function loadNextLevel() {
  clickSound();
  window.location.replace("level-seven.html");
}
