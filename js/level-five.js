    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          newContent1.textContent = "Level 6 Unlocked!";
          newContent2.className = "level level-description";
          newContent2.textContent =
            "Amazing. Let's now see how fast you can break this code.  You will be given three(3) minutes to solve this next level, so be prepared.";
