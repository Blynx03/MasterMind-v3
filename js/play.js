...
function checkAndShowFeedback() {
    ...
    if (attempt >= 10) {  // change 1 to 10 when done debugging
        ...
        setTimeout(function() {
            ...
            setTimeout(function() {
                ...
                setTimeout(function() {
                    ...
                    newContent1.textContent = "Level 2 Unlocked!";
                    newContent2.className = "level level-description";
                    newContent2.textContent = "Three more colors will be added to the color choices and number of attempts will be reduced to eight(8)!";
