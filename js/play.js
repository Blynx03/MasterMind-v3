      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          newContent2.textContent =
            "Three more colors will be added to the color choices and number of attempts will be reduced to eight(8)!";
...
footerNote.innerHTML =
  "The Dreamer " +
  year +
  '<span class="material-symbols-outlined rocket-icon">rocket_launch</span><span class="material-symbols-outlined fullscreen-icon>fullscreen</span>';
